...
public class Exercicio8 {
	...
	public void executar() {
		...
		while (continuar) {
			...
			System.out.println(" O Usuário:"+ nome+ " "+ "CPF:" + cpf + " terá seu salário liquido no valor de: " + salario_liquido);
			System.out.println("Para sair digite S, ou qualquer tecla para continuar ...");
